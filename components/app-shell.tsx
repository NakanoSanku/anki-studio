    ...
    >
      ...
      {!session ? (
        <header
          ...
          aria-label="应用顶栏"
        >
          <div className="mx-auto flex h-[68px] w-full max-w-7xl items-center gap-2.5 px-3 min-[390px]:h-[72px] min-[390px]:px-4 sm:h-20 sm:px-6">
            {header.backHref ? (
              <button
                type="button"
            ...
            {header.showDeck ? (
              ...
              >
                <div className="min-w-0">
                  <span className="anki-wordmark block text-[19px] min-[390px]:text-[20px] sm:text-[21px]">anki studio</span>
                  ...
                  {item.id === "study" && dueCount > 0 ? (
                    <span
                      className={cn(
                        ...
                        selected ? "bg-energy text-black" : "bg-energy text-black"
                      )}
                    >
